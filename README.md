...
keyboard = [
    [{"text": "📞 создатель", "url": "https://t.me/nanoharon"}],
    [{"text": "📦 GitHub", "url": "https://github.com/nanoharon/helper_real_live"}]
]

bot.sendMessage(text, reply_markup={"inline_keyboard": keyboard})